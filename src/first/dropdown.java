...
public class dropdown {
	...
	{
		WebElement mn1=driver.findElement(By.name("birthday_month"));
		Select mn=new Select(mn1);
	...
	{
		WebElement yy1=driver.findElement(By.name("birthday_year"));
		Select yy=new Select(yy1);
