...
import pack1.EXtendsReport;


public class IRTL  implements IReporter{
			...
			List<ISuite> suites, String outputDirectory) 
	{
		...
		for (ISuite suite : suites) {
		         ...
		         IResultMap failtest = con.getPassedTests();
		         ...
		         IResultMap skiptest = con.getPassedTests();

		         java.util.Set<ITestResult> alltoskip = failtest.getAllResults();
